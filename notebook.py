...
class notebookMain:
    def __init__(self, root):
        ...
        Button(mainframe, text = "View", command = self.notebookPopUp, width = 16).grid(column = 1, row = 2, pady = 4, padx = 8)
        Button(mainframe, text = "Create", command = self.gotoNotebookCreate, width = 16).grid(column = 2, row = 2, pady = 4, padx = 8)
...
class notebookCreate:
    def __init__(self, root):
        ...
        Label(mainframe, text = "Content:", font = Font(family = "Helvetica", size = 12)).grid(column = 1, row = 3, sticky = W)
